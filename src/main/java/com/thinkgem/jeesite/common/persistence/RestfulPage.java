 ...
 * @param <T>
 */
public class RestfulPage<T> extends Page<T> {
	
	private int pageNo = 1; // 当前页码
	private int pageSize = Integer.valueOf(Global.getConfig("api.page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
	 ...
	 */
	public RestfulPage(HttpServletRequest request, HttpServletResponse response){
	 ...
	 */
	public RestfulPage(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
	 ...
	 * @param pageSize 分页大小
	 */
	public RestfulPage(int pageNo, int pageSize) {
	 ...
	 * @param count 数据条数
	 */
	public RestfulPage(int pageNo, int pageSize, long count) {
	 ...
	 * @param list 本页数据对象列表
	 */
	public RestfulPage(int pageNo, int pageSize, long count, List<T> list) {
		this.setCount(count);
...
//	}
	 ...
	 * @param list
	 */
	public RestfulPage<T> setList(List<T> list) {
		this.list = list;
		initialize();
		return this;
	}
