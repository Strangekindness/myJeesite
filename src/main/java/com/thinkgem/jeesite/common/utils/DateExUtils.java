...
public class DateExUtils {
	...
	public static void main(String args[]) {
		...
		//某一天的开始时间
		System.out.println(getDayStartTime(date));
		//某一天的结束时间
		System.out.println(getDayEndTime(date));
		//某一月的开始时间
		System.out.println(getDayStartTime(getStartMonthDate(getYear(date), getMonth(date))));
		//某一月的结束时间
		System.out.println(getDayEndTime(getEndMonthDate(getYear(date), getMonth(date))));
		//某一年的开始时间
		System.out.println(getDayStartTime(getStartMonthDate(getYear(date), 1)));
		//某一年的结束时间
		System.out.println(getDayEndTime(getEndMonthDate(getYear(date), 12)));
