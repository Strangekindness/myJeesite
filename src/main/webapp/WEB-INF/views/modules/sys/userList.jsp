...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>归属公司</th><th>归属部门</th><th class="sort-column login_name">PC端登录名</th><th class="sort-column name">姓名</th><th>微信端登录名</th><!--<th>手机</th>--><th>用户类型</th><shiro:hasPermission name="sys:user:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<td>${user.phone}</td>
				<!-- <td>${user.mobile}</td> -->
				<td>${fns:getDictLabel(user.userType, 'sys_user_type', '未分配')}</td>
