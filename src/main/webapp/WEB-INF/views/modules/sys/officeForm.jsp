...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<%-- <div class="control-group">
			<label class="control-label">合盈客户编码:</label>
			<div class="controls">
				<form:select path="hyCustomerDepartmentId" class="input-large">
					<form:option value="" label="--请选择--"/>
					<form:options items="${fns:getCustomerDepartmentList()}" itemLabel="name" itemValue="id" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">合盈销售编码:</label>
			<div class="controls">
				<form:select path="hySalesDepartmentId" class="input-large">
					<form:option value="" label="--请选择--"/>
					<form:options items="${fns:getSalesDepartmentList('1')}" itemLabel="name" itemValue="id" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">合溪销售编码:</label>
			<div class="controls">
				<form:select path="hxSalesDepartmentId" class="input-large">
					<form:option value="" label="--请选择--"/>
					<form:options items="${fns:getSalesDepartmentList('2')}" itemLabel="name" itemValue="id" htmlEscape="false"/>
				</form:select>
			</div>
		</div> --%>
		<div class="control-group">
